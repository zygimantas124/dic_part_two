...
from components.tables import get_target_tables
from components.obstacles import get_carpets, get_people, get_furniture
from components.walls import get_walls
